...
public class Game 
{
	...
	private int art_totalSize;   // Total mobility of player's possession.
	private int art_totalValue;   // Total value of player's possession.
	...
	public void  displayInstructions()
	{
		...
		System.out.println (" Some new rules: ");
		System.out.println ("1) Each player is allowed to take only 3 artifacts");
		System.out.println ("2) If you want to take more than 3 artifacts, grab the leather bag. Leather bag allows you to take any number of artifacts.");
		System.out.println ("3) Each Player is given 500 points of initial health.");
       	System.out.println ("4) Player's health decreases when he goes from one room to another. Amount of heath decrease depends upon the total weightage in bag.");
       	System.out.println ("For example, if total weightage of bag is 40 and player's health is 500. Then going from 'Place A' -->'Place B' will reduce its health ");
       	System.out.println ("to 460. ");
       	System.out.println ("Health formula:");
       	System.out.println (" New health = Old health - total weight of load(bag) carried.");
		System.out.println ("5) Player can increase the health by using the artifacts of gold whose value is more than 100. ");
		System.out.println ("For example, using artifacts like Pot O Gold, sparkling rubies will increase the health of player by 50 points.");
		System.out.println ("Note: By using the artifact, it will be removed from the player's possession.");
		System.out.println ("6) Purple potion maximizes the health of player to 500 points.");
		    	...
		    	for ( int i=0;  i < number ; i++)
		    	{
		    		line = getCleanLine(game);             // call the function to get a clean line.
		 		    ...
		 		    if ( type.equalsIgnoreCase("PLAYER"))
		 		    {
		 		    	...
		 		    	line = getCleanLine(game); 
		 		    	Scanner inp = new Scanner (line);
		 		    
		 		    	int whichPlaceId = inp.nextInt();
	...
	public void play()
	{
	    ...
	    while(true)
	    {
	    	for ( int i=0;  i < characters.size() ; i++)
			{
				...
				// Please select the interface you want to make.
